...
h1 = f1.Get("3j_RECO/3j_delY_resol")
#h2 = f2.Get("3j_RECO_semi/3j_delY_resol")
h2 = f2.Get("YUKAWA_RECO/yukawa_delY_resol")
h3 = f1.Get("3j_RECO_wrong/3j_delY_resol")
#h3 = h2.Clone()
#h3.Add(h1)
...
#scale2 = 1/h3.Integral()
#scale3 = scale1/h3.Integral()
h1.Scale(1/h1.Integral())
h2.Scale(1/h2.Integral())
#h3.Scale(scale3)
#h1.GetXaxis().SetTitle("M_{t#bar{t}} resolution")
h1.GetXaxis().SetTitle("#Deltay (RECO-GEN)/GEN")
h1.GetYaxis().SetTitle("normalized")
h1.SetTitle("#Deltay resolution")
...
#leg.AddEntry(h3,"3j wrong","l")
leg.Draw("same")

cmstext()

c1.SaveAs("resoldely.pdf")
c1.SaveAs("resoldely.png")
