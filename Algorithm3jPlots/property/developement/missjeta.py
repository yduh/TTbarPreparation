...
h1 = f.Get("3j_MISSJ/3j_max_nseta_right")
h2 = f.Get("3j_MISSJ/3j_max_nseta_wrong")
#h3 = h2.Clone()
#h3.Add(h1)
...
gright.SetName("nsetamax_bhright")
gwrong.SetName("nsetamax_bhwrong")
#gright.Draw("AC")
#gwrong.Draw("AC")
gright.Write()
gwrong.Write()
